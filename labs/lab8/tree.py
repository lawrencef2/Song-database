...
class Tree:
    ...
    def num_internal_nodes(self) -> int:
        if self.is_empty():
            ...
            total = 0
            for subtree in self._subtrees:
                total += subtree.num_internal_nodes()
            return 1 + total

    def total_branching(self) -> int:
        if self.is_empty():
            return 0
        elif self._subtrees == []:
            return 0
    ...
    def branching_factor(self) -> float:
        ...
        if self.is_empty():
            ...
            return self.total_branching() / self.num_internal_nodes()
    ...
    def items_at_depth(self, d: int) -> list:
        ...
        if self.is_empty():
            ...
            final_list = []
            for subtree in self._subtrees:
                final_list.extend(subtree.items_at_depth(d-1))
            return final_list
    ...
    def nested_list(self) -> list:
        if self.is_empty():
            ...
            final_list = []
            final_list.append(self._root)
            for subtree in self._subtrees:
                final_list.append(subtree.nested_list())
            return final_list
